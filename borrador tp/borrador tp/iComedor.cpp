...
void iComedor::subir_nivel()
{
	...
	cout << GREEN_TEXT << "Has subido el nivel del comedor! Ahora esta en el nivel " << this->nivel << RESET<< endl; 
	cout << "Has aumentado la capacidad de entregar energia del comedor! Ahora es " << this->capacidad << endl;
